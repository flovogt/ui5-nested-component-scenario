 ...
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 */
sap.ui.predefine("sap/ui/layout/designtime/form/FormContainer.designtime", ["sap/ui/thirdparty/jquery","sap/ui/core/Element","sap/ui/layout/form/Form"],function(jQuery,e,t){"use strict";function n(e){return e.getFormElements().every(function(e){return e.getVisible()===false})}function r(e){if(e&&!(e instanceof t)){return r(e.getParent())}return e}function o(e){var t=r(e);if(t&&t.getLayout()&&t.getLayout().isA("sap.ui.layout.form.GridLayout")){return false}return true}return{palette:{group:"LAYOUT",icons:{svg:"sap/ui/layout/designtime/form/FormContainer.icon.svg"}},isVisible:function(e){return e.isVisible()},actions:{remove:function(e){if(o(e)){return{changeType:"hideControl"}}else{return null}},rename:function(e){if(o(e)){return{changeType:"renameGroup",domRef:function(e){if(!e.getRenderedDomRef()){var t=e.getTitle()||e.getToolbar();return t.getRenderedDomRef?.()||t.getDomRef()}return jQuery(e.getRenderedDomRef()).find(".sapUiFormTitle")[0]},isEnabled:function(e){return!(e.getToolbar()||!e.getTitle())}}}else{return null}}},aggregations:{formElements:{childNames:{singular:"FIELD_CONTROL_NAME",plural:"FIELD_CONTROL_NAME_PLURAL"},domRef:function(t){var r=t.getRenderedDomRef();var o=t.getTitle()||t.getToolbar();if(r){return r}if(t.getFormElements().length===0||n(t)){if(o instanceof e){return o.getRenderedDomRef?.()||o.getDomRef()}if(typeof o==="string"){return jQuery(r).find(".sapUiFormTitle").get(0)}}return undefined},actions:{move:function(e){if(o(e)){return{changeType:"moveControls"}}else{return null}},remove:{removeLastElement:true},add:{delegate:function(e){if(o(e)){return{changeType:"addFormField",changeOnRelevantContainer:true}}}}}},toolbar:{domRef:function(e){var t=e.getToolbar();if(t){return t.getDomRef()}}}},name:{singular:"GROUP_CONTROL_NAME",plural:"GROUP_CONTROL_NAME_PLURAL"}}});
/*!
 * OpenUI5
 * (c) Copyright 2026 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
